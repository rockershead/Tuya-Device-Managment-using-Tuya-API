...
const tuya_off=function(accessToken,device_id){
   return new Promise(function(resolve,reject){
    ...
    const offBody={"commands":[{"code": "switch_1","value":false}]}


    var nonce = config.nonce
    const path='/v1.0/devices/'+device_id+'/commands'
      var signStr=stringToSign(path,httpMethod,offBody)
